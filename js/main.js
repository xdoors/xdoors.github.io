...
$(function() {
  var bookmark = {
    data: [{
      ...
      name: 'HOSTLOC',
      link: 'https://www.hostloc.com/forum-45-1.html',
      box_shadow: '#F57923',
      icon: 'https://www.hostloc.com/favicon.ico',
    }, {
      name: 'V2EX',
      link: 'https://www.v2ex.com/go/all4all?p=1',
      box_shadow: '#2C2C2C',
      icon: 'https://www.v2ex.com/favicon.ico',
    }, {
      name: 'cnBeta',
      link: 'http://cnbeta.com/',
      box_shadow: '#37bf4c',
      ...
      name: '云添加',
      link: 'http://d.ojpojp.com/',
      box_shadow: '#62677b',
      icon: 'img/log.png',
    }, {
      name: 'BTbbT',
      link: 'http://www.52btbtt.com/',
      box_shadow: '#D7191A',
      icon: 'http://www.52btbtt.com/favicon.ico',
    }, {
      name: '西瓜视频',
      link: 'https://www.ixigua.com/my/attention/new',
      box_shadow: '#3279ea',
      ...
      name: '倍可亲',
      link: 'https://www.backchina.com/news/',
      box_shadow: '#7C5DC7',
      icon: 'img/bkq.ico',
    }, {
      name: 'G-Map',
      link: 'https://www.google.com/maps/@40.7417759,-73.9101737,12.61z',
      box_shadow: '#00A0E9',
      ...
      name: '吾爱破解',
      link: 'https://www.52pojie.cn/forum-10-1.html',
      box_shadow: '#00A0E9',
      icon: 'http://www.52pojie.cn/favicon.ico',
    }, {
      name: '品葱',
      link: 'https://pincong.rocks/',
      box_shadow: '#62677b',
      icon: 'https://pincong.rocks/favicon.ico',
    }, {
      name: '福利吧',
      link: 'https://fuliba2020.net/',
      box_shadow: '#7C5DC7',
      icon: 'https://fuliba2020.net/favicon.ico',
    }, {
      name: 'MacAPP',
...
var time = d.getHours();
if (time < 24) {
  document.getElementById("title").innerHTML = "CJ Directory | Good evening";
}
if (time < 18) {
  document.getElementById("title").innerHTML = "CJ Directory | Good afternoon";
}
if (time < 12) {
  document.getElementById("title").innerHTML = "CJ Directory | Good morning";
}
if (time < 5) {
  document.getElementById("title").innerHTML = "CJ Directory | Stay up late again";
}
//title问候语结束
